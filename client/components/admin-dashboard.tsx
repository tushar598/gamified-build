...
//             <TabsTrigger value="overview" className="rounded-md data-[state=active]:bg-blue-100 data-[state=active]:text-blue-600">
//               Overview
//             </TabsTrigger>
//             <TabsTrigger value="content" className="rounded-md data-[state=active]:bg-blue-100 data-[state=active]:text-blue-600">
//               Content
//             </TabsTrigger>
//             <TabsTrigger value="users" className="rounded-md data-[state=active]:bg-blue-100 data-[state=active]:text-blue-600">
//               Users
//             </TabsTrigger>
//             <TabsTrigger value="analytics" className="rounded-md data-[state=active]:bg-blue-100 data-[state=active]:text-blue-600">
//               Analytics
//             </TabsTrigger>
//             <TabsTrigger value="system" className="rounded-md data-[state=active]:bg-blue-100 data-[state=active]:text-blue-600">
//               System
//             </TabsTrigger>
//           </TabsList>
...
//                 </CardHeader>
//                 <CardContent>
//                   <div className="text-2xl font-bold text-gray-900">$24,680</div>
//                   <p className="text-xs text-green-600 mt-1">
//                     +15.3% from last month
//                   </p>
//                 </CardContent>
...
//               <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//                 <CardHeader>
//                   <CardTitle className="text-lg font-semibold text-gray-900">Recent User Registrations</CardTitle>
//                 </CardHeader>
//                 <CardContent>
//                   <div className="space-y-3">
//                     {recentUsers.map((user, index) => (
...
//               <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//                 <CardHeader>
//                   <CardTitle className="text-lg font-semibold text-gray-900">Upload New Quiz</CardTitle>
//                   <p className="text-sm text-gray-600">
//                     Add new quizzes by providing details and uploading quiz data.
//                   </p>
//                 </CardHeader>
//                 <CardContent className="space-y-4">
//                   <div className="space-y-2">
//                     <Label htmlFor="quiz-title" className="text-gray-900">Quiz Title</Label>
//                     <Input
//                       id="quiz-title"
//                       placeholder="e.g., Advanced Calculus"
...
//                   </div>
//                   <div className="space-y-2">
//                     <Label htmlFor="quiz-subject" className="text-gray-900">Subject</Label>
//                     <Input id="quiz-subject" placeholder="e.g., Mathematics" className="border-gray-300" />
//                   </div>
//                   <div className="space-y-2">
//                     <Label htmlFor="quiz-description" className="text-gray-900">Description</Label>
//                     <Textarea
//                       id="quiz-description"
//                       placeholder="Briefly describe the quiz content and objectives."
//                       className="border-gray-300"
...
//                   </div>
//                   <div className="space-y-2">
//                     <Label htmlFor="quiz-file" className="text-gray-900">Quiz Data File (JSON/CSV)</Label>
//                     <Input id="quiz-file" type="file" accept=".json,.csv" className="border-gray-300" />
//                   </div>
...
//               <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//                 <CardHeader>
//                   <CardTitle className="text-lg font-semibold text-gray-900">Asset Management</CardTitle>
//                   <p className="text-sm text-gray-600">
//                     Edit, delete, and organize multilingual content assets.
//                   </p>
//                 </CardHeader>
...
//             <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//               <CardHeader>
//                 <CardTitle className="text-lg font-semibold text-gray-900">Manage Existing Quizzes</CardTitle>
//                 <p className="text-sm text-gray-600">
//                   Edit or delete quizzes from the platform.
//                 </p>
//               </CardHeader>
...
//                           <td className="py-3 px-4 text-gray-900">{quiz.subject}</td>
//                           <td className="py-3 px-4 text-gray-900">{quiz.questions}</td>
//                           <td className="py-3 px-4">
//                             <Badge
//                               className={
//                                 quiz.status === "Active" 
...
//             <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//               <CardHeader>
//                 <CardTitle className="text-lg font-semibold text-gray-900">User Management Tools</CardTitle>
//               </CardHeader>
//               <CardContent className="space-y-4">
//                 <div className="flex flex-col sm:flex-row gap-4">
//                   <Input
...
//             <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//               <CardHeader>
//                 <CardTitle className="text-lg font-semibold text-gray-900">Platform Analytics</CardTitle>
//                 <p className="text-sm text-gray-600">
...
//                         <span className="text-sm font-medium text-gray-900">12.4 min</span>
//                       </div>
...
//                         <p className="font-semibold text-yellow-600">125ms avg</p>
//                       </div>
//                     </div>
//                     <AlertTriangle className="w-6 h-6 text-yellow-600" />
//                   </div>
...
//             <Card className="bg-white rounded-xl shadow-sm border border-gray-200">
//               <CardHeader>
//                 <CardTitle className="text-lg font-semibold text-gray-900">Resource Usage</CardTitle>
//               </CardHeader>
//               <CardContent className="space-y-4">
//                 <div>
//                   <div className="flex justify-between mb-2">
